...
void initialize()
{
    ...
    Goal[ USER ].defineBlankSpace( Goal[ USER ].getX(), Goal[ USER ].getY() + GOAL_THICK, GOAL_WIDTH - GOAL_THICK, GOAL_HEIGHT - GOAL_THICK + 10);
    ...
    Goal[ COMPUTER ].defineBlankSpace( Goal[ COMPUTER ].getX() + GOAL_THICK, Goal[ COMPUTER ].getY() + GOAL_THICK, GOAL_WIDTH - GOAL_THICK, GOAL_HEIGHT - GOAL_THICK + 10);
